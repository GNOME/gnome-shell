 ...
 * @value: (optional): the current value
 * @lower: (optional): the lower bound
 * @upper: (optional): the upper bound
 * @step_increment: (optional): the step increment
 * @page_increment: (optional): the page increment
 * @page_size: (optional): the page size
 *
