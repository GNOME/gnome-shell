 ...
 *
 * In detail, @node_a and @node_b are considered equal if
 *
 ...
 * @side: a #StCorner
 *
 * Get the border width for @node on @side.
 *
 ...
 * @corner: a #StCorner
 *
 * Get the border radius for @node at @corner.
 *
 ...
 * @node: a #StThemeNode
 *
 * Get the width of the outline for @node.
 *
 ...
 * @node: a #StThemeNode
 *
 * Get the minimum width for @node.
 *
 ...
 * @node: a #StThemeNode
 *
 * Get the minimum height for @node.
 *
 ...
 * @node: a #StThemeNode
 *
 * Get the maximum width for @node.
 *
 ...
 * @node: a #StThemeNode
 *
 * Get the maximum height for @node.
 *
 ...
 * @side: a #StSide
 *
 * Get the padding for @node on @side. This corresponds to the CSS properties
 * such as `padding-top`.
 *
 ...
 * @side: a #StSide
 *
 * Get the margin for @node on @side. This corresponds to the CSS properties
 * such as `margin-top`.
 *
 ...
 *
 * Returns: the total horizonal padding in pixels
 */
double
 ...
 *
 * Returns: the total vertical padding in pixels
 */
double
