                      ...
                      ClutterPaintNode *node)
{
  ...
  clutter_paint_node_set_name (pipeline_node, "ShellBlurEffect (final)");
                   ...
                   uint8_t           paint_opacity)
{
  ...
  vblur_node = clutter_layer_node_new_with_framebuffer (vblur->data.framebuffer,
                                                        vblur->data.pipeline,
                                                        paint_opacity);
  clutter_paint_node_set_name (vblur_node, "ShellBlurEffect (vertical pass)");
  ...
  hblur_node = clutter_layer_node_new_with_framebuffer (hblur->data.framebuffer,
                                                        hblur->data.pipeline,
                                                        255);
  clutter_paint_node_set_name (hblur_node, "ShellBlurEffect (horizontal pass)");
  ...
  brightness_node = clutter_layer_node_new_with_framebuffer (self->brightness_fb.framebuffer,
                                                             ...
                                                             255);
  clutter_paint_node_set_name (brightness_node, "ShellBlurEffect (brightness)");
                  ...
                  ClutterActorBox     *source_actor_box)
{
  ...
  background_node =
    clutter_layer_node_new_with_framebuffer (self->background_fb.framebuffer,
                                             ...
                                             255);
  clutter_paint_node_set_name (background_node, "ShellBlurEffect (background)");
  ...
  blit_node = clutter_blit_node_new (framebuffer,
                                     self->background_fb.framebuffer);
  clutter_paint_node_set_name (blit_node, "ShellBlurEffect (blit)");
                ...
                ClutterPaintNode *node)
{
  ...
  actor_node = clutter_actor_node_new (self->actor);
                       ...
                       ClutterEffectPaintFlags  flags)
{
  ...
  clutter_paint_node_set_name (transform_node, "ShellBlurEffect (downscale)");
  clutter_paint_node_add_child (layer_node, transform_node);

  add_actor_node (self, transform_node);
