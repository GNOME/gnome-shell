...
class GtkNotificationDaemonAppSource extends MessageTray.Source {
    ...
    showNotification(notificationId, notificationParams, showBanner) {
...
var GtkNotificationDaemon = class GtkNotificationDaemon {
        ...
        if (value) {
            ...
            sources.forEach(([appId, notifications]) => {
                ...
                notifications.forEach(([notificationId, notification]) => {
                    source.showNotification(notificationId, notification.deep_unpack(), false);
                });
            });
        }
    ...
    AddNotificationAsync(params, invocation) {
        ...
        source.showNotification(notificationId, notification, true);
