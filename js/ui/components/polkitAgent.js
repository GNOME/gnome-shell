...
var AuthenticationDialog = GObject.registerClass({
    ...
    _init(actionId, description, cookie, userNames) {
        ...
        let capsLockWarning = new ShellEntry.CapsLockWarning({ style_class: 'prompt-dialog-caps-lock-warning' });
    ...
    _onSessionRequest(session, request, echoOn) {
        ...
        this._passwordEntry.hint_text = request == 'Password:' || request == 'Password: '
            ? _('Enter Password…') : request;
