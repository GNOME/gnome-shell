...
var WorkspaceAnimationController = class {
    ...
    _switchWorkspaceBegin(tracker, monitor) {
        ...
        let baseDistance = Main.layoutManager.monitors[monitor].height - Main.panel.height;

        let backDistance = this._animation.getDistance(monitor, Meta.MotionDirection.DOWN);
        let forwardDistance = this._animation.getDistance(monitor, Meta.MotionDirection.UP);
