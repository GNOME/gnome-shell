...
class UnlockDialogClock extends St.BoxLayout {
    ...
    _updateHint() {
        ...
        else if (authMechanism?.role === GdmConst.PASSKEY_ROLE_NAME)
...
class UnlockDialogLayout extends Clutter.LayoutManager {
    ...
    vfunc_allocate(container, box) {
        ...
        // Authentication Box - center it vertically
        let centerY = height / 2.0;
        let stackY = Math.floor(centerY - stackHeight / 2.0);
...
export const UnlockDialog = GObject.registerClass({
    ...
    _init(parentActor) {
        ...
        this._authIndicatorButton.add_style_class_name('login-dialog-auth-indicator-button');
