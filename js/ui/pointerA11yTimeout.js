...
var PieTimer = class PieTimer {
    constructor() {
        ...
        this.actor = new St.DrawingArea({ style_class: 'pie-timer',
                                          visible: false,
                                          can_focus: false,
                                          reactive: false });
    ...
    start(x, y, duration) {
        ...
        this.actor.x = x - this.actor.width / 2;
        this.actor.y = y - this.actor.height / 2;
        this.actor.show();
        ...
        Tweener.addTween(this.actor, {
            ...
            onUpdateScope: this,
            onUpdate() { this.actor.queue_repaint() },
