...
class DwellClickIndicator extends PanelMenu.Button {
    _init() {
        ...
        this._a11ySettings.connect('changed::' + KEY_DWELL_CLICK_ENABLED, this._queueSyncMenuVisibility.bind(this));
        this._a11ySettings.connect('changed::' + KEY_DWELL_MODE, this._queueSyncMenuVisibility.bind(this));
    ...
    _queueSyncMenuVisibility() {
        ...
        GLib.Source.set_name_by_id(this._syncMenuVisibilityIdle, '[gnome-shell] this._syncDwellMenuVisibility');
    }
    ...
    _setClickType(mode) {
        let settings = new Clutter.PointerA11ySettings();

        this._deviceManager.get_pointer_a11y_settings(settings);
        settings.dwell_click_type = mode.type;
        this._deviceManager.set_pointer_a11y_settings(settings);
