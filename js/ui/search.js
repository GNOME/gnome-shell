...
var GridSearchResults = new Lang.Class({
    ...
    _getMaxDisplayedResults() {
        let contentThemeNode = this._parent._content.get_theme_node();
        ...
        let contentBinMaxWidth = this._parent._contentBin.get_theme_node().get_max_width();
