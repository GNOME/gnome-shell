...
class LookingGlassResult extends St.BoxLayout {
...
class LookingGlassWindowList extends St.BoxLayout {
    _init(lookingGlass) {
...
class LookingGlassExtensions extends St.BoxLayout {
    _init(lookingGlass) {
...
class LookingGlass extends St.BoxLayout {
    ...
    close() {
        ...
        Tweener.addTween(this, {
            time: Math.min(0.5 / St.get_slow_down_factor(), 0.5),
            transition: 'easeOutQuad',
            y: this._hiddenY,
