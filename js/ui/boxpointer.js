...
var BoxPointer = new Lang.Class({
    ...
    vfunc_get_preferred_width(forHeight) {
        ...
        let [minWidth, natWidth] = this.bin.get_preferred_width(forHeight);
        [minWidth, natWidth] = this._adjustAllocationForArrow(true, minWidth, natWidth);
    ...
    vfunc_get_preferred_height(forWidth) {
        ...
        let [minHeight, natHeight] = this.bin.get_preferred_height(forWidth - 2 * borderWidth);
        [minHeight, natHeight] = this._adjustAllocationForArrow(false, minHeight, natHeight);
