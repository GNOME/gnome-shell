...
var BoxPointer = new Lang.Class({
    ...
    vfunc_get_preferred_width(forHeight) {
        ...
        [minInternalSize, natInternalSize] = this._adjustAllocationForArrow(true, minInternalSize, natInternalSize);

        return themeNode.adjust_preferred_width(minInternalSize, natInternalSize);
    },
    ...
    vfunc_get_preferred_height(forWidth) {
        ...
        [minSize, naturalSize] = this._adjustAllocationForArrow(false, minSize, naturalSize);

        return themeNode.adjust_preferred_height(minSize, naturalSize);
    },
