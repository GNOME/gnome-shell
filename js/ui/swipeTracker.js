...
var SwipeTracker = GObject.registerClass({
     ...
     * Checks whether the event can be handled by the tracker.
     * This function can be used to combine swipe gesture and mouse scrolling.
    ...
    _getClosestSnapPoints() {
        let lower = this._snapPoints.reverse().find(p => p <= this._progress);
     ...
     * matching a non-transient state.
     */
