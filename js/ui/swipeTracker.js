...
const TOUCHPAD_BASE_DISTANCE_X = 400;
const TOUCHPAD_BASE_DISTANCE_Y = 250;
const SCROLL_MULTIPLIER = 10;
const SWIPE_MULTIPLIER = 1/2;
...
var TouchpadSwipeGesture = class TouchpadSwipeGesture {
    ...
    _handleEvent(_actor, event) {
        ...
        if (this._orientation == Clutter.Orientation.VERTICAL)
            delta = dy / TOUCHPAD_BASE_DISTANCE_Y;
        else
            delta = dx / TOUCHPAD_BASE_DISTANCE_X;
