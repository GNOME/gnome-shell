...
var SwipeTracker = class {
    ...
    set enabled(enabled) {
        ...
        this._touchpadGesture.enabled = enabled;
        this._touchGesture.enabled = enabled;
        if (this._dragGesture)
            this._dragGesture.enabled = enabled;
        if (this._scrollGesture)
            this._scrollGesture.enabled = enabled;
    }
    ...
    set orientation(orientation) {
        ...
        this._touchpadGesture.orientation = orientation;
        this._touchGesture.orientation = orientation;
        if (this._dragGesture)
            this._dragGesture.orientation = orientation;
        if (this._scrollGesture)
            this._scrollGesture.orientation = orientation;
    }
    ...
    confirmSwipe(distance, snapPoints, currentProgress, cancelProgress) {
        ...
        this._touchGesture.distance = distance;
        if (this._dragGesture)
            this._dragGesture.distance = distance;
