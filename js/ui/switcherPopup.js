...
var SwitcherList = new Lang.Class({
    ...
    _init(squareItems) {
        ...
        layoutManager.spacing = 0;
        this._list.connect('style-changed', () => {
            this._list.spacing = this._list.get_theme_node().get_length('spacing');
            layoutManager.spacing = this._list.spacing;
        });
    ...
    vfunc_allocate(box, flags) {
        ...
        let [minScrollViewWidth, ] = this._scrollView.get_preferred_width(height);

        let childBox = new Clutter.ActorBox();
        let scrollable = minScrollViewWidth > width;
