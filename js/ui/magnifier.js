...
var MouseSpriteContent = GObject.registerClass({
    ...
    _textureScale() {
        ...
        /* This is a workaround to guess the sprite scale; while it works
         * fine in normal scenarios, it's not garanteed to work in all the cases,
        ...
        return avgSize / Meta.prefs_get_cursor_size();
    }
