...
var SafeDesktopArea = GObject.registerClass({
     ...
     * margins.
     *
     * @returns {int} a numeric ID to identify this element/extension. It is never 0.
     */
    register() {
        this._idCounter += 1;
     ...
     * @returns {int} The monitor index (starting from 0), or -1 if it falls outside
     * all the monitors
     */
