...
var Panel = new Lang.Class({
    ...
    _init() {
        ...
        this.connect('get-preferred-width', this._getPreferredWidth.bind(this));
        this.connect('get-preferred-height', this._getPreferredHeight.bind(this));
        this.connect('allocate', this._allocate.bind(this));
