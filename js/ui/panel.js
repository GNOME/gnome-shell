...
var Panel = new Lang.Class({
    ...
    _init : function() {
        ...
        global.screen.connect('workareas-changed', Lang.bind(this, this._updatePanel));
        this._updatePanel();
    },
    ...
    _allocate: function(actor, box, flags) {
        ...
        /* leftOffset - rightOffset (simplified)
         * (workArea.x - monitor.x) - (monitor.width - ((workArea.x - monitor.x) + workArea.width))
         */
        let centerOffset = 2 * (workArea.x - monitor.x) + workArea.width - monitor.width;
