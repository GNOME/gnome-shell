...
var IconGridLayout = GObject.registerClass({
    ...
    _findBestIconSize() {
        ...
        const firstItem = this._actor.get_first_child();
    ...
    vfunc_set_container(container) {
        if (this._actor) {
            this._actor.disconnect(this._actorDestroyedId);
            this._actor = null;
        }
        ...
        if (this._actor)
            this._actorDestroyedId = this._actor.connect('destroy', this._onDestroy.bind(this));
    }
