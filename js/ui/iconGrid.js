...
var BaseIcon = new Lang.Class({
    ...
    vfunc_style_changed() {
        ...
        this._box.get_layout_manager().spacing = node.get_length('spacing');
...
var IconGrid = new Lang.Class({
    ...
    visibleItemsCount() {
        let nSkipPaint = this.get_children().filter(actor => actor.skip_paint).length;
        return this.get_n_children() - nSkipPaint;
    },
