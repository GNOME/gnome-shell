...
var CloseDialog = GObject.registerClass({
    ...
    _updateScale() {
        // Since this is a child of MetaWindowActor (which applies the geometry
        // scale factor to its children itself), make sure we don't apply the
        // factor twice in the end.
