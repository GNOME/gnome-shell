...
var HotCorner = class HotCorner {
    constructor(layoutManager, monitor, x, y) {
        ...
        let gravity = Clutter.Gravity.NORTH_WEST;
        if (Clutter.get_default_text_direction() == Clutter.TextDirection.RTL)
            gravity = Clutter.Gravity.NORTH_EAST;
        this._ripples = new Ripples.Ripples(layoutManager, x, y, gravity, 'ripple-box');
    }
