...
var EventSourceInterface = GObject.registerClass({
    ...
    Signals: { 'changed': {} }
}, class Calendar_EventSourceInterface extends GObject.Interface {
    get isLoading() {
...
}, class Calendar_EmptyEventSource extends GObject.Object {
    get isLoading() {
        return false;
    }
...
}, class Calendar_DBusEventSource extends GObject.Object {
    _init() {
        super._init();
        this._resetCache();
