...
var Lightbox = GObject.registerClass({
    Signals: { 'shown': {} },
    Properties: {
        'inhibit-events': GObject.ParamSpec.boolean(
            'inhibit-events', 'inhibit-events', 'inhibit-events',
            GObject.ParamFlags.READWRITE | GObject.ParamFlags.CONSTRUCT_ONLY,
            false),
        'radial-effect': GObject.ParamSpec.boolean(
            'radial-effect', 'radial-effect', 'radial-effect',
            GObject.ParamFlags.READWRITE | GObject.ParamFlags.CONSTRUCT_ONLY,
            false),
        'fade-factor': GObject.ParamSpec.double(
            'fade-factor', 'fade-factor', 'fade-factor',
            GObject.ParamFlags.READWRITE | GObject.ParamFlags.CONSTRUCT_ONLY,
