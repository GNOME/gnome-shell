...
var _Draggable = class _Draggable {
    ...
    startDrag(stageX, stageY, time, sequence, device) {
        ...
        if (this.actor._delegate && this.actor._delegate.getDragActor) {
            ...
            const newAllocatedWidth = this._dragActor.get_preferred_width(-1)[1];
            const newAllocatedHeight = this._dragActor.get_preferred_height(-1)[1];
            ...
            this._dragActor.set_scale(
                stageAllocation.get_width() / newAllocatedWidth,
                stageAllocation.get_height() / newAllocatedHeight);

            this._dragOffsetX = stageAllocation.x1 - this._dragStartX;
            this._dragOffsetY = stageAllocation.y1 - this._dragStartY;
