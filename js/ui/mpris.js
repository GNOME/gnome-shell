    ...
    _updateState() {
        ...
        if (!Array.isArray(this._trackArtists) ||
            ...
            if (typeof this._trackArtists !== 'undefined')
                log(`Received faulty track artist metadata from ${this._busName
                    }; expected an array of strings, got ${this._trackArtists
                    } (${typeof this._trackArtists})`);
        ...
        if (typeof this._trackTitle !== 'string') {
            if (typeof this._trackTitle !== 'undefined')
                log(`Received faulty track title metadata from ${this._busName
                    }; expected a string, got ${this._trackTitle} (${
                    typeof this._trackTitle})`);
        ...
        if (typeof this._trackCoverUrl !== 'string') {
            if (typeof this._trackCoverUrl !== 'undefined')
                log(`Received faulty track cover art metadata from ${
                    this._busName}; expected a string, got ${this._trackCoverUrl
                    } (${typeof this._trackCoverUrl})`);
            this._trackCoverUrl = '';
        }
