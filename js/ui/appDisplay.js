...
var AllView = class AllView extends BaseAppView {
    ...
    _redisplay() {
        ...
        let addedIDs = allIDs.filter(id => !this._items.hasOwnProperty(id));
...
var FrequentView = class FrequentView extends BaseAppView {
    ...
    _redisplay() {
        ...
        let addedApps = mostUsed.filter(shellApp => !this._items.hasOwnProperty(shellApp.get_app_info().get_id()));
...
var FolderView = class FolderView extends BaseAppView {
    ...
    _redisplay() {
        ...
        let addedIDs = folderAppIDs.filter(id => !this._items.hasOwnProperty(id));
