...
var AllView = class AllView extends BaseAppView {
    ...
    _redisplay() {
        ...
        let removedIDs = Object.keys(this._items).filter(id => !allIDs.includes(id));
        let addedIDs = allIDs.filter(id =>
            !Object.prototype.hasOwnProperty.call(this._items, id));
...
var FrequentView = class FrequentView extends BaseAppView {
    ...
    _redisplay() {
        ...
        let removedApps = Object.values(this._items).filter(appIcon => !mostUsed.includes(appIcon.app));
        let addedApps = mostUsed.filter(shellApp =>
            !Object.prototype.hasOwnProperty.call(this._items, shellApp.get_app_info().get_id()));
...
var FolderView = class FolderView extends BaseAppView {
    ...
    _redisplay() {
        ...
        let removedIDs = Object.keys(this._items).filter(id => !folderAppIDs.includes(id));
        let addedIDs = folderAppIDs.filter(id =>
            !Object.prototype.hasOwnProperty.call(this._items, id));
