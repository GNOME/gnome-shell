...
var PageManager = GObject.registerClass({
    ...
    _init() {
        ...
        global.settings.connect('changed::grid-layout', this._loadPages.bind(this));

        this._loadPages();
    }

    _loadPages() {
        this._pages = global.settings.get_value('grid-layout').recursiveUnpack();
    ...
    set pages(p) {
        ...
        global.settings.set_value('grid-layout', variant);
    }
