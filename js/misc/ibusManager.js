...
var IBusManager = class {
    ...
    _onConnected() {
        ...
        this._ibus.list_engines_async(-1, this._ibusCancellable,
            this._initEngines.bind(this));
        this._ibus.request_name_async(IBus.SERVICE_PANEL,
            IBus.BusNameFlag.REPLACE_EXISTING, -1, this._ibusCancellable,
    ...
    _initPanelService(ibus, result) {
        ...
        if (success) {
            ...
            this._ibus.get_global_engine_async(-1, this._ibusCancellable, (_bus, result) => {
                let engine;
                try {
    ...
    setEngine(id, callback) {
        ...
        this._ibus.set_global_engine_async(id,
            ...
            this._ibusCancellable, (_bus, res) => {
                try {
