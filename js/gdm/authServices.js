...
export class AuthServices extends GObject.Object {
    static [GObject.signals] = {
         ...
         * @param {boolean} [wiggle]
         */
        'queue-message': {param_types: [GObject.TYPE_JSOBJECT]},
        /**
         * @param {string} serviceName
         * @param {string} message
         * @param {MessageType} messageType
         * @param {boolean} [wiggle]
         */
        'queue-priority-message': {param_types: [GObject.TYPE_JSOBJECT]},
        /**
         * @param {Gio.Task} task
         */
        'wait-pending-messages': {param_types: [GObject.TYPE_JSOBJECT]},
        /**
         * @param {string} serviceName
         * @param {MessageType} messageType
         */
        'filter-messages': {param_types: [GObject.TYPE_JSOBJECT]},
        /**
         * @param {string} serviceName
         * @param {boolean} [canRetry]
         */
        'verification-failed': {param_types: [GObject.TYPE_JSOBJECT]},
         ...
         * @param {boolean} [reuseEntryText]
         */
        'reset': {param_types: [GObject.TYPE_JSOBJECT]},
        /**
         * @param {string} serviceName
    ...
    async _verificationFailed(serviceName, shouldRetry) {
        ...
        this.emit('verification-failed', {serviceName, canRetry: !doneTrying});
