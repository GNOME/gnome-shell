...
const CredManager = imports.gdm.credentialManager;
...
var VmwareCredentialsManager = class VmwareCredentialsManager extends CredManager.CredentialManager {
    constructor() {
        super(VMWARE_SERVICE_NAME);
