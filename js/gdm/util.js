...
var ShellUserVerifier = class {
    constructor(client, params) {
        ...
        if (this._credentialManagers[OVIRT_SERVICE_NAME].hasToken())
            this._oVirtUserAuthenticated(this._credentialManagers[OVIRT_SERVICE_NAME].getToken());

        this._credentialManagers[OVIRT_SERVICE_NAME]._authenticatedSignalId =
            this._credentialManagers[OVIRT_SERVICE_NAME].connect('user-authenticated',
                                                                 this._oVirtUserAuthenticated.bind(this));

        this._credentialManagers[VMWARE_SERVICE_NAME]._authenticatedSignalId =
            this._credentialManagers[VMWARE_SERVICE_NAME].connect('vm-authenticated',
    ...
    _onConversationStopped(client, serviceName) {
        ...
        // mechanism.
        let foregroundCredentialManagers = Object.keys(this._credentialManagers).find(service =>
            this.serviceIsForground(service));
        if (foregroundCredentialManagers) {
            this.foregroundCredentialManagers.resetToken();
            this._preemptingService = null;
            this._verificationFailed(false);
            return;
        }
